...
test_that("Package documentation and imports are properly defined", {
  # Test that the package has proper structure
  expect_true(exists("_PACKAGE", envir = asNamespace("ospsuite.plots"), inherits = FALSE))
...
test_that("Package namespace is properly structured", {
  ...
  expected_functions <- c(
    ...
    "constructLabelWithUnit", "getFoldDistanceList"
  )
