...
> **Note:** Residual calculation has been moved out of `ospsuite.plots`. Residuals and ratios must be pre-calculated before passing them to the plotting functions. If you are using the `{ospsuite}` package, use `ospsuite::addResidualColumn()` to add a residual column to your data.
