...
```{r Default-ggplot-Layout, warning=FALSE}
...
```{r Set-ospsuite.plots-Layout, warning=FALSE, fig.show='hold'}
...
```{r Reset-to-Previously-Saved-Layout, warning=FALSE, fig.show='hold'}
...
```{r Customize-colors: set to gray colors}
...
```{r Change-format-and-label-of-watermark}
...
```{r Default-Shapes, out.width = "90%", fig.asp = 0.4, fig.width = 8}
...
```{r Use-Unicode-Symbols, fig.showtext=TRUE, out.width = "90%", fig.asp = 0.8, fig.width = 8}
