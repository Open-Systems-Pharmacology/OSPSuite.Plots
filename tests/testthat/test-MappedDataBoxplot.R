...
test_that("MappedDataBoxplot initialization works correctly", {
  ...
  expect_r6_class(mapped_data, "MappedDataBoxplot")
  expect_r6_class(mapped_data, "MappedData")
...
test_that("MappedDataBoxplot doAdjustmentsWithMetaData works correctly", {
  ...
  mapped_data_numeric <- MappedDataBoxplot$new(
  ...
  expect_no_error({
    mapped_data_numeric$doAdjustmentsWithMetaData(
  ...
  expect_equal(mapped_data_numeric$xscale, "linear")
