...
By default (`lloqDirection = "observedDataDirection"`), the LLOQ line is drawn only perpendicular to the observed data axis. Setting `lloqDirection = "both"` draws LLOQ lines on both the x and y axes. This is quite useful, as it makes it clear if the simulated results should be considered as "quantifiable" or not.
