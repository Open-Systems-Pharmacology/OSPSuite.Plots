...
By default (`lloqDirection = "observedDataDirection"`), the LLOQ line is drawn only along the observed data axis. Setting `lloqDirection = "both"` draws LLOQ lines on both the x and y axes, which is useful when the same LLOQ applies to both axes.
