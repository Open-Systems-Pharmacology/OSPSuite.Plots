...
If a plot function is called wit variable `plotObject = NULL`, internally the function  `initializePlot` with variables `metaData` and `mapping` is called. This function constructs labels from the metadata, and adds a watermark layer.
