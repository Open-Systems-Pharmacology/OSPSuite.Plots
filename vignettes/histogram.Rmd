...
The variable `geomHistAttributes` is set by default to `getDefaultGeomAttributes("Hist")`, which is a list with entries `bins = 10`, `position = ggplot2::position_nudge()`, `color = "black"` and `alpha = 0.5`.
