...
```{r Test-Data-Extraction, results='asis'}
...
```{r Reset-to-Previously-Saved-Color-Map}
...
```{r Defaults-for-Aesthetics, eval=FALSE}
# Default alpha = 0.5
...
```{r Advanced-Usage-exportPlot, eval=FALSE}
