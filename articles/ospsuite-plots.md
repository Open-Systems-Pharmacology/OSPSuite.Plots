...
[Time Profile
Plots](https://www.open-systems-pharmacology.org/OSPSuite.Plots/articles/plot-time-profile.md)

### 3.2 `plotBoxWhisker()`

[Box Whisker
Plots](https://www.open-systems-pharmacology.org/OSPSuite.Plots/articles/box-whisker-vignette.md)

### 3.3 `plotHistogram()`

[Histogram
Plots](https://www.open-systems-pharmacology.org/OSPSuite.Plots/articles/histogram.md)

### 3.4 `plotPredVsObs()`

[Goodness of
Fit](https://www.open-systems-pharmacology.org/OSPSuite.Plots/articles/Goodness_of_fit.md)
